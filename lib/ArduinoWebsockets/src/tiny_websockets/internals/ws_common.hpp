...
namespace websockets {
    ...
    #include <tiny_websockets/network/picow/picow_tcp.hpp>

    #define WSDefaultTcpClient websockets::network::PicoWTcpClient
    #define WSDefaultTcpServer websockets::network::PicoWTcpServer
#endif
